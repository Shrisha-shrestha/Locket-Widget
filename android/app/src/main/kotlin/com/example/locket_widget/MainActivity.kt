...
import com.example.locket_widget.databinding.ActivityMainBinding
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, CHANNEL).setMethodCallHandler { call, result ->
            if (call.method == "clickPhoto") {
                ...
                // } else {
                //     result.error("UNAVAILABLE", "An Error Occurred.", null)
                // }
            } else {
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_CODE_PERMISSIONS) {
            if (allPermissionsGranted()) {
                ...
                // finish() // Optionally close the activity if permissions are not granted
            }
        }
    }
...
private fun startCamera() {
    ...
    companion object {
        private const val TAG = "locket_widget"
